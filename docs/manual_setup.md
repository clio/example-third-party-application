...
This application utilizes Ruby `3.2.11` and Rails `7.0.8.4`. These can be installed through a variety of methods using different package managers, choose the right one for your system and preferences.
