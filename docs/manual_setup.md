...
This application utilizes Ruby `3.1.6` and Rails `6.1.7.8`. These can be installed through a variety of methods using different package managers, choose the right one for your system and preferences.
